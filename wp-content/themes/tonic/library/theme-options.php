...
class Bavotasan_Customizer {
	...
	public function customize_register( $wp_customize ) {
		...
		$wp_customize->add_setting( 'tonic_theme_options[number_posts]', array(
		...
		$wp_customize->add_control( 'bavotasan_number_posts', array(
			...
			'section' => 'bavotasan_layout',
			'settings' => 'tonic_theme_options[number_posts]',
			'priority' => 45,
		) );

		$wp_customize->add_setting( 'tonic_theme_options[blog_url]', array(
		...
		$wp_customize->add_control( 'bavotasan_blog_url', array(
			...
			'section' => 'bavotasan_layout',
			'settings' => 'tonic_theme_options[blog_url]',
			'priority' => 55,
		) );
